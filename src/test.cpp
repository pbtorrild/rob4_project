...
void inside(cv::Rect sqr, int shapetype, int colourshape, std::vector<cv::Point>& contour){
	...
	if (shapetype == 10) {
		...
		cv::Mat triangles[] = { cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/mainsideroad"), cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/yield"), cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/kids ")};
	...
	if(shapetype == 20){
		...
		//Array containing the paths to all the templates, it is important they are in order
		cv::Mat rectangles[] = { cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/WalkerTemp ")};
		//Array containg the ratio between the sign and the image insige it, this is used to scale the template later
	...
	if (shapetype == 30) {
		...
		//Array containing the paths to all the templates, it is important they are in order
		cv::Mat circles[] = { cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/dontgoleft "), cv::imread("/home/peter/catkin_ws/src/torrilds_package/src/templates/70 ") };
		//Array containg the ratio between the sign and the image insige it, this is used to scale the template later

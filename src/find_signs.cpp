...
void inside(cv::Rect sqr, int shapetype, int colourshape, std::vector<cv::Point>& contour) {
	...
	if (shapetype == 10) {
		...
		cv::Mat triangles[] = { cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/mainsideroad.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/yield.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/kids.png") };
	...
	if (shapetype == 20) {
		...
		//Array containing the paths to all the templates, it is important they are in order
		cv::Mat rectangles[] = { cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/WalkerTemp.png") };
		//Array containg the ratio between the sign and the image insige it, this is used to scale the template later
	...
	if (shapetype == 30) {
		...
		//Array containing the paths to all the templates, it is important they are in order
		cv::Mat circles[] = { cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/dontgoleft.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/70.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/30.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/50.png"), cv::imread("/home/pi/catkin_ws/src/rob4_pkg/src/templates/blank.png") };
		//Array containg the ratio between the sign and the image insige it, this is used to scale the template later
